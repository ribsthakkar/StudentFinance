...
+ (RLMArray<id> * _Nonnull)_rlmArray;
/**
...
/**
  ...
  note:
  Equality comparison is implemented by \code
  isEqual(_:)
  \endcode. If the object type
  is defined with a primary key, \code
  isEqual(_:)
  \endcode behaves identically to this
  method. If the object type is not defined with a primary key,
  \code
  isEqual(_:)
  \endcode uses the \code
  NSObject
  \endcode behavior of comparing object identity.
...
*/
- (BOOL)isSameObjectAs:(RealmSwiftObject * _Nullable)object;
/**
